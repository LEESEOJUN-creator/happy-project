    ...
    <div className="signup-container">
      <div className="signup-card">
        ...
        <div className="form-group">
          <label>사용할 ID</label>
          <Input type="text" placeholder="사용할 ID 입력해주세요" />
        </div>

        <div className="form-group">
          <label>비밀번호</label>
          <Input type="password" placeholder="사용할 비밀번호 입력해주세요" />
        </div>
        ...
        <div className="form-group">
          <label>프로필 사진</label>
          <div className="upload-box">Click to upload profile picture <br /><small>PNG, JPG up to 5MB</small></div>
        </div>

        <div className="form-group">
          <label>학생증 사진</label>
          <div className="upload-box">Upload Student ID Photo <br /><small>Clear photo of your student ID</small></div>
        </div>

        <label className="terms">
          <Input type="checkbox" id="agree" />
          서비스 약관 및 개인정보 보호 정책에 동의합니다
        </label>

        <Button name="계정만들기">계정 만들기</Button>
